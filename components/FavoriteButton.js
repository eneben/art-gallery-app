...
// Jetzt fehlt uns inmmernoch die isFavorite-prop, oder? Die ist, glaube ich, in _app.js noch nicht definiert.
// Chat GPT sagt "Doch!""
export default function FavoriteButton({ isFavorite, onToggleFavorite }) {
  ...
  return (
    ...
    >
      ...
      {/* fill: true/false probieren */}
      {/* isFavorite - ausgefüllt, !isFavorite = leer*/}
      {/* button comp ums svg, durchsichtig */}
    </StyledFavoriteButtonComponent>
  );
}
